...
void PSquareTable::init() {
    VALUES[PAWN]=100; VALUES[KNIGHT]=320; VALUES[BISHOP]=330;
    VALUES[ROOK]=500; VALUES[QUEEN]=900; VALUES[KING]=2000;
...
void PSquareTable::addPiece(Color color, PieceType pieceType, unsigned int square) {
  _scores[OPENING][color] += VALUES[pieceType] + PIECE_VALUES[OPENING][color][pieceType][square];
  _scores[ENDGAME][color] += VALUES[pieceType] + PIECE_VALUES[ENDGAME][color][pieceType][square];
}
